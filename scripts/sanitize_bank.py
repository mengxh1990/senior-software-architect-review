...
DOMAIN_LABEL_TOPIC_RULES = {
    ...
    "§4": (
        ("K03.SOFTWARE_DESIGN_UML", ("uml", "mda", "面向对象", "内聚", "耦合", "类图", "用例", "设计原则", "迪米特", "里氏", "依赖倒置", "mvc", "模块化", "软件工具")),
        ...
        ("K06.DESIGN_DATA_VIEWS", ("概要设计", "软件结构", "软件文档", "数据设计", "界面设计", "输入设计", "输出设计", "详细设计", "用户文档", "处理流程", "系统建议", "系统设计")),
    ),
