...
> **数据来源**：[CSDN pccaiqq 134097142](https://blog.csdn.net/pccaiqq/article/details/134097142) + [掘金 7144645783126540324](https://juejin.cn/post/7144645783126540324) + [xxlllq/system_architect](https://github.com/xxlllq/system_architect) + 贡献者购买的扫描件转录（2009–2022 与 2024 下、2025 上）。2026 上半年由考生回忆版 PDF 补充，未提交原文件，且未与官方原卷交叉验证。
>
...
## 2-补. 2024 下–2026 上 论文真题（新增）

> 2025 下 / 2026 上来源：wujiaming88/awesome-ruankao（考后回忆版 + 交叉验证）；2024 下 / 2025 上来源：贡献者购买的回忆还原版扫描件转录。完整题干见 [`essay-by-year/2024下.md`](./essay-by-year/2024下.md) 与 [`essay-by-year/2025上.md`](./essay-by-year/2025上.md)。

### 2024 年下半年

| # | 题目 | 主题映射 |
|---|---|---|
| 1 | 论软件维护及其应用 | 01 软件架构设计 / 09 架构演化 |
| 2 | 论面向服务的架构设计 | 07 SOA |
| 3 | 论多源异构数据集成方法 | 11 企业应用集成 EAI |
| 4 | 论分布式事务及其解决方案 | 17 分布式事务 / 16 中间件 |

### 2025 年上半年

| # | 题目 | 主题映射 |
|---|---|---|
| 1 | 论软件测试方法及应用 | 12 测试质量 |
| 2 | 论多模型数据库及应用 | 06 大数据 / NoSQL |
| 3 | 论事件驱动架构 | 10 设计模式 / 15 微服务 |
| 4 | 论负载均衡技术 | 05 微服务 / 性能 |
